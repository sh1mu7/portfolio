# Generated by Django 4.1.6 on 2023-02-17 19:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(default='static/media/logo.png', null=True, upload_to='media/website_logos/%Y/%m/%d/')),
                ('bg_color', models.CharField(default='#0d1117', help_text='color_code: #000000', max_length=7, null=True)),
                ('font_color', models.CharField(default='#00cb87', help_text='color_code: #000000', max_length=7, null=True)),
            ...
            options={
                'ordering': ['-created_at'],
                'permissions': [('view_site_info', 'Can view website information')],
            },
        ),
        migrations.CreateModel(
            name='Skill',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('file', models.FileField(default='static/media/resume.pdf', upload_to='media/resume/temp')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='static/media/default.webp', null=True, upload_to='media/projects')),
                ('thumbnail', models.ImageField(default='static/media/default.webp', null=True, upload_to='media/projects/thumbnail')),
